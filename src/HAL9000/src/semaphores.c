...
//    }
//
//    _Analysis_assume_lock_acquired_(*Semaphore->Lock);
//
//    LockRelease(&Semaphore->Lock, dummyState);
//
...
//}
//
//void SemaphoreUp(PSEMAPHORE Semaphore, DWORD Value) // check mutex release
//{
//    INTR_STATE oldState;
//    PTHREAD pThread;
//    PLIST_ENTRY pEntry;
...
//    oldState = CpuIntrDisable();
//
//    LockAcquire(Semaphore->Lock, &oldState);
...
//    _Analysis_assume_lock_acquired_(*Semaphore->Lock);
//
//    LockRelease(&Semaphore->Lock, oldState);
//
//    CpuIntrSetState(oldState);
//    
//}
