...
// truncated and invalid handle
#define CL_STATUS_TRUNCATED_PROCESS_NAME                   (ERROR_MASK | CUSTOMER_BIT | GENERAL_MASK | 0x0036UL)
#define CL_STATUS_INVALID_HANDLE		                   (ERROR_MASK | CUSTOMER_BIT | GENERAL_MASK | 0x0037UL)
...
#define STATUS_INVALID_HANDLE							CL_STATUS_INVALID_HANDLE
